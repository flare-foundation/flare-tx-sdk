        ...
        for (let wallet of wallets) {
            describe(wallet.getDescription(), function () {
                ...
                it("unpayable contract method", async function () {
                    ...
                    await network.invokeContractMethodOnC(wallet, "WNat", abi, "delegate", BigInt(0), env.cAddress1, bips)
                    ...
                    assert.strictEqual(delegates[0].address, env.cAddress1, "invalid delegate")
